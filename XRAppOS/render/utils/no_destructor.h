// Copyright 2019 The CameraLink Authors.
//
...
#ifndef CAMERALINK_DEPS_NO_DESTRUCTOR_H_
#define CAMERALINK_DEPS_NO_DESTRUCTOR_H_
...
#endif  // CAMERALINK_DEPS_NO_DESTRUCTOR_H_
